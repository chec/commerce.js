...
## Edit online
The simplest way to edit the documentation is to do it on GitHub's interface. All documentation source is located in `commerce.js/docs`, so all you'll need to do is find the appropriate `.md` file in [chec/commerce.js/docs](https://github.com/chec/commerce.js/tree/master/docs) and edit.
...
3. Make edits in your favourite code editor on a new branch
...
- Commit messages should be in the imperative tense, i.e. *Edit the intro section of cart* vs. *Edited the intro section of cart*
