...
Commerce = (function() {
  ...
  class Commerce {
    ...
    Ajax(options) {
      var args, e, k, ref, request, timeout, v;
      args = {
        method: 'GET',
        async: true,
        data: null,
...
Commerce.Storage = class Storage {
...
Commerce.Categories = class Categories {
  constructor(c) {
    this.c = c;
  }
...
Commerce.Checkout = class Checkout {
  constructor(c) {
    this.c = c;
  }
...
Commerce.Merchants = class Merchants {
  constructor(c) {
    this.c = c;
  }
...
Commerce.Products = class Products {
  constructor(c) {
    this.c = c;
  }
...
Commerce.Services = class Services {
  constructor(c) {
    this.c = c;
  }
